      ...
      <Modal isOpen={modal} toggle={toggle} centered backdrop={true} size="lg">
        ...
        <ModalBody>
          <form className="mt-4" action="#" onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
              <label className="form-label" htmlFor="delivery_charge_1">
                Delivery Charge({value0})
              </label>
              <input
                type="number"
                className="form-control"
                ...
                name="delivery_charge_1"
                required
                onChange={handleInputs}
                value={zoneInfo.delivery_charge_1}
              />
            </div>

            <div className="mb-3">
              <label className="form-label" htmlFor="delivery_charge_2">
                Delivery Charge({value1})
              </label>
              <input
                type="number"
                className="form-control"
                id="delivery_charge_2"
                placeholder="Enter Delivery Charge"
                name="delivery_charge_2"
                required
                onChange={handleInputs}
                value={zoneInfo.delivery_charge_2}
              />
            </div>

            <div className="mb-3">
              <label className="form-label" htmlFor="delivery_charge_3">
                Delivery Charge({value2})
              </label>
              <input
                type="number"
                className="form-control"
                id="delivery_charge_3"
                placeholder="Enter Delivery Charge"
                name="delivery_charge_3"
                required
                onChange={handleInputs}
                value={zoneInfo.delivery_charge_3}
              />
            </div>
