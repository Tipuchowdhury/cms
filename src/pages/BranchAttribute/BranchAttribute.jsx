...
function BranchAttribute(props) {
  ...
  useEffect(() => {
    ...
    props.add_branch_attribute_loading,
    props.branch_attribute_edit_loading,
    props.branch_attribute_delete_loading,
    props.branch_attribute_status_edit_loading,
  ])
      ...
      <div className="page-content">
        <Container fluid>
          ...
          <Breadcrumbs
            maintitle="Foodi"
            title="Branch"
            breadcrumbItem="Branch-Attribute"
          />
          <Row>
            <Col className="col-12">
              <Card>
                <CardBody>
                  ...
                  {props.get_all_branch_attribute_data ? (
                    props.get_all_branch_attribute_data.length > 0 ? (
        ...
        <Modal isOpen={modal} toggle={toggle} centered>
          ...
          <ModalBody>
            <form className="mt-1" onSubmit={handleSubmit}>
              <div className="mb-3">
                <label className="form-label" htmlFor="branchAttributeName">
                  Branch Attribute Name
                </label>
                <input
                  type="text"
                  className="form-control"
                  id="branchAttributeName"
                  placeholder="Enter branch attribute name"
                  required
                  name="branchAttributeName"
                  value={addInfo.branchAttributeName}
            ...
            <form className="mt-1" onSubmit={handleEdit}>
              <div className="mb-3">
                ...
                <input
                  ...
                  name="branchAttributeName"
                  onChange={handleInputs}
                  value={editInfo.branchAttributeName}
                />
              </div>
