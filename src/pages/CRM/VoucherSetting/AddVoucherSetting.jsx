...
function AddVoucherSetting(props) {
  ...
  document.title = location.state
    ? "Edit Voucher Setting | Foodi"
    : "Add Voucher Setting | Foodi"
  ...
  const [voucherSettingInfo, setVoucherSettingInfo] = useState({
    ...
    voucher_cost_in_point: location.state
      ? location.state.voucher_cost_in_point
      : 0,
                  ...
                  <Row className="mb-3">
                    ...
                    <div className="col-md-10">
                      <input
                        ...
                        onChange={handleInputs}
                        value={voucherSettingInfo.voucher_cost_in_point ?? ""}
                        required
                      />
                    </div>
                  </Row>
                  ...
                  <Row className="mb-3">
                    ...
                    <div className="col-md-10">
                      <input
                        ...
                        name="validity_time"
                        onChange={handleInputs}
                        value={voucherSettingInfo.validity_time ?? ""}
                        required
                      />
                    </div>
                  </Row>
                    ...
                    <div className="col-sm-4">
                      <div className="form-check">
                        ...
                        <input
                          ...
                          id="is_delivery"
                          checked={voucherSettingInfo.is_delivery}
                          name="is_delivery"
                    ...
                    <div className="col-sm-4">
                      <div className="form-check">
                        ...
                        <input
                          ...
                          className="form-check-input"
                          id="is_pickup"
                          checked={voucherSettingInfo.is_pickup}
                          name="is_pickup"
                          onChange={handleCheckBox}
                        />
                      </div>
                    ...
                    <div className="col-sm-4">
                      <div className="form-check">
                        ...
                        <input
                          ...
                          className="form-check-input"
                          id="is_dine"
                          checked={voucherSettingInfo.is_dine}
                          name="is_dine"
                          onChange={handleCheckBox}
                        />
                      </div>
