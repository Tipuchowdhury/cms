...
function CustomerEdit(props) {
    ...
    if (props.get_all_subscription_type_data?.length > 0) {
        subscriptionData = props.get_all_subscription_type_data?.map((item, key) => ({
            label: item.name,
            value: item._id,
        }))
    }
    ...
    const handleEditSubmit = e => {
        ...
        props.customerEditAction(location.state._id, editInfo, selectedSubscription[0].value)
    }
    ...
    useEffect(() => {
        ...
        if (props.get_customer_by_id_data != undefined) {
            ...
            setEditImages({ ...editImages, image: props?.get_customer_by_id_data?.image })
                //setRole()
                ;
            let edit_data_subscription = props.get_all_subscription_type_data.filter((item) => item._id == props?.get_customer_by_id_data?.subscription_type_id)
            setSelectedSubscription({ label: edit_data_subscription[0].name, value: edit_data_subscription[0]._id })
