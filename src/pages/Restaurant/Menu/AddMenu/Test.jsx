...
function AddMenu(props) {
  ...
  const [isChecked, setIsChecked] = useState(
    location.state ? (location.state.check_add_ons == 1 ? true : false) : false
  )
  ...
  const checkTimeSelected = time_slot_id => {
    ...
    const found = selectedTimeSlot.map(obj => {
      if (obj.menu_item_time_slot_id === time_slot_id) {
        return_check = 1
      }
      // return obj.menu_item_time_slot_id === time_slot_id
    })
                        ...
                        >
                          <div style={{ marginTop: "30px" }}>
                            <input
                              ...
                              value="true"
                              checked={checkTimeSelected(item._id)}
