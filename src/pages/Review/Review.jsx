...
function Review(props) {
  ...
  useEffect(() => {
    ...
    props.add_review_loading,
    props.review_edit_loading,
    props.review_delete_loading,
    props.review_status_edit_loading,
  ])
            ...
            <Col className="col-12">
              <Card style={{ border: "none" }}>
                <CardBody>
                  ...
                  {props.get_all_review_data ? (
                    props.get_all_review_data.length > 0 ? (
                      <DatatableTablesWorking
                        products={props.get_all_review_data}
                        columnData={activeData}
                        defaultSorted={defaultSorted}
                        key={props.get_all_review_data?._id}
                      />
                    ) : null
                  ) : null}
                </CardBody>
