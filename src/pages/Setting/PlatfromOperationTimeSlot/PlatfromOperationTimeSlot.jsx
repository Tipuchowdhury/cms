...
function PlatfromOperationTimeSlot(props) {
  ...
  useEffect(() => {
    ...
    props.add_operation_time_slot_loading,
    props.operation_time_slot_edit_loading,
    props.operation_time_slot_delete_loading,
    props.operation_time_slot_status_edit_loading,
  ])
      ...
      <div className="page-content">
        <Container fluid>
          ...
          <Breadcrumbs
            maintitle="Foodi"
            title="Settings"
            breadcrumbItem="System Operation Time Slot"
          />
          <Row>
            <Col className="col-12">
              <Card style={{ border: "none" }}>
                <CardBody>
                  ...
                  {props.get_all_operation_time_slot_data ? (
                    props.get_all_operation_time_slot_data.length > 0 ? (
                      <DatatableTablesWorking
                        products={props.get_all_operation_time_slot_data}
                        columnData={activeData}
                        defaultSorted={defaultSorted}
                        key={props.get_all_operation_time_slot_data?._id}
                      />
                    ) : null
                  ) : null}
                </CardBody>
