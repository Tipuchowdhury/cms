...
function SystemOnOffReason(props) {
  ...
  useEffect(() => {
    ...
    props.add_reason_loading,
    props.reason_edit_loading,
    props.reason_delete_loading,
    props.reason_status_edit_loading,
  ])
      ...
      <div className="page-content">
        <Container fluid>
          ...
          <Breadcrumbs
            maintitle="Foodi"
            title="Settings"
            breadcrumbItem="System On Off Reason"
          />
          <Row>
            <Col className="col-12">
              <Card style={{ border: "none" }}>
                <CardBody>
                  ...
                  {props.get_all_reason_data ? (
                    props.get_all_reason_data.length > 0 ? (
                      <DatatableTablesWorking
                        products={props.get_all_reason_data}
                        columnData={activeData}
                        defaultSorted={defaultSorted}
                        key={props.get_all_reason_data?._id}
                      />
                    ) : null
                  ) : null}
                </CardBody>
