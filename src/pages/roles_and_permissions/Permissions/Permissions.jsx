...
function Permissions(props) {
  ...
  useEffect(() => {
    ...
    props.add_permission_loading,
    props.permission_edit_loading,
    props.permission_delete_loading,
    props.permission_status_edit_loading,
  ])
            ...
            <Col className="col-12">
              <Card>
                <CardBody>
                  ...
                  {props.get_all_permission_data ? (
                    props.get_all_permission_data.length > 0 ? (
                      <DatatableTablesWorking
                        products={props.get_all_permission_data}
        ...
        <Modal isOpen={modal} toggle={toggle} centered>
          ...
          <ModalBody>
            <form className="mt-1" onSubmit={handleSubmit}>
              <div className="mb-3">
                <label className="form-label" htmlFor="module_name">
                  Permission Name
                </label>
                <input
                  type="text"
              ...
              <div className="mb-3 row">
                <div className="col-sm-6">
                  <div className="form-check">
                    <label className="form-check-label" htmlFor="is_create">
                      Create
                    </label>
                    <input
                      type="checkbox"
                ...
                <div className="col-sm-6">
                  <div className="form-check">
                    <label className="form-check-label" htmlFor="is_update">
                      Edit
                    </label>
                    <input
                      type="checkbox"
                ...
                <div className="col-sm-6">
                  <div className="form-check">
                    <label className="form-check-label" htmlFor="is_delete">
                      Delete
                    </label>
                    <input
                      type="checkbox"
