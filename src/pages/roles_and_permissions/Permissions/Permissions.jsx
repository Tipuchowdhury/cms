...
function Permissions(props) {
    ...
    const pathForEdit = (nn) => {
        ...
        const selectedPath = nn ? nn.map((item, key) => {
    ...
    const handlePath = (e, index) => {
        // console.log(index);
        const updatedValue = path.map((row, i) => index === i ? Object.assign(row, { [e.target.name]: e.target.value }) : row);
    ...
    const handlePathEdit = (e, index) => {
        // console.log(e);
        const updatedValue = pathEdit.map((row, i) => index === i ? Object.assign(row, { [e.target.name]: e.target.value }) : row);
                                    ...
                                    <div data-repeater-list="group-a" id={"addr" + idx}>
                                        <div data-repeater-item className="row">
                                            ...
                                            <div className="mb-3 col-lg-10">
                                                ...
                                                <input type="text" id="path" className="form-control" name="path" placeholder="Path" value={row.path} onChange={(e) => handlePath(e, idx)} />
                                            </div>
                                ...
                                <React.Fragment key={idx}>
                                    <div data-repeater-list="group-a" id={"addr" + idx}>
                                        <div data-repeater-item className="row">
                                            ...
                                            <div className="mb-3 col-lg-10">
                                                <label className="form-label" htmlFor="path">Path</label>
                                                <input type="text" id="path" className="form-control" name="path" placeholder="Path" value={row.path} onChange={(e) => handlePathEdit(e, idx)} />
                                            </div>
