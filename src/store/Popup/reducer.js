...
const initialState = {
  ...
  get_popup_by_id_data: null,
  get_popup_by_id_error: null,
  get_popup_by_id_loading: false,
}
...
const Popup = (state = initialState, action) => {
  switch (action.type) {
    ...
    case GET_POPUP_BY_ID:
      state = {
        ...state,
        get_popup_by_id_data: action.payload,
        get_popup_by_id_error: null,
        get_popup_by_id_loading: action.status,
      }
      break

    case GET_POPUP_BY_ID_FRESH:
      state = {
        ...state,
        get_popup_by_id_data: null,
        get_popup_by_id_loading: action.status,
