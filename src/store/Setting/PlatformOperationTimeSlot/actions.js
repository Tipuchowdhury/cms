import {
  ADD_OPERATION_TIME_SLOT,
  ADD_OPERATION_TIME_SLOT_FRESH,
  GET_ALL_OPERATION_TIME_SLOT,
  GET_ALL_OPERATION_TIME_SLOT_FRESH,
  OPERATION_TIME_SLOT_EDIT,
  OPERATION_TIME_SLOT_EDIT_FRESH,
  OPERATION_TIME_SLOT_DELETE,
  OPERATION_TIME_SLOT_DELETE_FRESH,
  OPERATION_TIME_SLOT_STATUS_EDIT,
...
export const operationTimeSlotDeleteAction = id => {
  var url =
    process.env.REACT_APP_LOCALHOST + "/PlatfromOperationTimeSlot/Delete"
  // console.log(id);
